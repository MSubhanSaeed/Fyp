    ...
    private fun setupCheckBox() {
        ...
        val checkBoxClickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                ...
                Toast.makeText(this@SignupScreen, "Terms and Conditions clicked!", Toast.LENGTH_SHORT).show()
            }

            override fun updateDrawState(ds: TextPaint) {
                super.updateDrawState(ds)
                // Customize the appearance of the clickable text
                ds.color = ContextCompat.getColor(this@SignupScreen, R.color.teal_700) // Set text color
